...
def test_otx_url_links_preserve_scheme_separator():
    ...
    assert (
        vt_lookup["url"]
        == "https://www.virustotal.com/gui/url/aHR0cDovL3d3dy53My5vcmcvMTk5OC9NYXRoL01hdGhNTA/detection"
    )
...
def test_otx_url_links_escape_query_and_fragment_delimiters():
    ...
    assert (
        vt_lookup["url"]
        == "https://www.virustotal.com/gui/url/aHR0cHM6Ly9leGFtcGxlLmNvbS9hP2I9YyZkPWUjZnJhZw/detection"
    )
    assert (
        otx_lookup["url"]
        == "https://otx.alienvault.com/indicator/url/https:%2F%2Fexample.com%2Fa%3Fb%3Dc%26d%3De%23frag"
    )
...
def test_referenced_urls_are_split_from_network_callouts():
    ...
    assert (
        referenced_vt["url"] == "https://www.virustotal.com/gui/url/aHR0cHM6Ly9kb2NzLmV4YW1wbGUvcmVmZXJlbmNl/detection"
    )
...
def test_virustotal_url_lookup_uses_url_identifier_for_postman_ioc():
    ...
    assert (
        vt_lookup["url"]
        == "https://www.virustotal.com/gui/url/aHR0cHM6Ly9hbmFseXRpY3MuZ2V0cG9zdG1hbi1iZXRhLmNvbS9ldmVudHM/detection"
    )
